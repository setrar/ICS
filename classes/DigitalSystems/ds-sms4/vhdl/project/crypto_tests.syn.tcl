...
create_bd_port -dir I -type data sresetn
create_bd_port -dir I -type data shift
create_bd_port -dir I -type data go
create_bd_port -dir I -type data din
create_bd_port -dir O -type data dout
connect_bd_net [get_bd_pins $ip/sresetn] [get_bd_ports sresetn]
connect_bd_net [get_bd_pins $ip/shift] [get_bd_ports shift]
connect_bd_net [get_bd_pins $ip/go] [get_bd_ports go]
connect_bd_net [get_bd_pins $ip/din] [get_bd_ports din]
connect_bd_net [get_bd_pins $ip/dout] [get_bd_ports dout]
...
set_false_path -from clk -to [get_ports dout]
set_false_path -from [get_ports sresetn] -to clk
set_false_path -from [get_ports shift] -to clk
set_false_path -from [get_ports go] -to clk
set_false_path -from [get_ports din] -to clk
